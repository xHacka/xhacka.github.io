...
> Note: I used [mft](https://github.com/omerbenamram/mft) parser for initial phase since I had used it before, but next question answer is not in the csv generated by tool.
