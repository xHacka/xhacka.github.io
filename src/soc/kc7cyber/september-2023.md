...
### 1. On August 29, 2023, law enforcement announced they disrupted which very large botnet?
...
### 1. Which PowerShell cmdlet can be used to send an HTTP or HTTPS web request to a web page or web service?
...
### 1. True or False: There are never hacking incidents that occur on holiday weekends such as Labor Day weekend.
...
### 1. On September 1, 2023, it was reported that hackers are targeting which exposed server to deploy FreeWorld ransomware? Use the abbrievated server type.
...
### 1. On August 23, 2023, the British Court sentenced two hackers from which hacking group, responsible for hacking into tech firms?
...
### 1. On August 31, 2023, Cisco Talos released a report on a popular information stealing malware that was recently open sourced and used by hackers. What was the name of this malware?
...
### 1. Japan’s National Center of Incident Readiness and Strategy for Cybersecurity (NISC) released a statement about a breach that occurred within their networks on August 4, 2023. Now, it is being reported that which country may be responsible for this breach?
...
### 1. On September 9, 2023, it was reported that a specific malware variant was being pushed through Microsoft Teams phishing messages. What's the name of the malware?
...
### 1. What digital forensic tool has the logo of a dog holding a magnifying glass?
...
### 1. Which CVE did CISA add to its Known Exploited Vulnerabilities Catalog on September 6?

Google dorking: `site:cisa.gov "2023-09-06"` -> [Known Exploited Vulnerabilities Catalog](https://www.cisa.gov/known-exploited-vulnerabilities-catalog?f%5B0%5D=vendor_project%3A794&f%5B1%5D=vendor_project%3A795&f%5B2%5D=vendor_project%3A800&f%5B3%5D=vendor_project%3A801&f%5B4%5D=vendor_project%3A817&f%5B5%5D=vendor_project%3A823&f%5B6%5D=vendor_project%3A837&f%5B7%5D=vendor_project%3A842&f%5B8%5D=vendor_project%3A845&f%5B9%5D=vendor_project%3A852&f%5B10%5D=vendor_project%3A854&f%5B11%5D=vendor_project%3A875&f%5B12%5D=vendor_project%3A886&f%5B13%5D=vendor_project%3A893&f%5B14%5D=vendor_project%3A902&f%5B15%5D=vendor_project%3A909&f%5B16%5D=vendor_project%3A917&f%5B17%5D=vendor_project%3A932&f%5B18%5D=vendor_project%3A938&f%5B19%5D=vendor_project%3A944&f%5B20%5D=vendor_project%3A1007&f%5B21%5D=vendor_project%3A1147&f%5B22%5D=vendor_project%3A1267&page=1) -> [CVE-2023-33246](https://www.cve.org/CVERecord?id=CVE-2023-33246)
...
### 1. On September 9, 2023, which organization reported that car companies have some of the worst data privacy policies in place?
...
### 1. What four step decision making model, adopted from military strategy, is used in Cyber Threat Intelligence?
...
### 1. What is the MITRE ATT&CK ID for a Command and Control technique used to obfuscate its intended origin by taking advantage of Content Delivery Networks (CDNs)?
...
### 1. What is the name of the regional internet registry for the Asia-Pacific region?
...
### 1. What is the name of the DoD's unified combatant command that is focused on cyberspace operations?
...
### 1. Which updated man-in-the-middle framework was created by Kuba Gretzky to bypass 2FA?
...
### 1. What common application suite developed by Portswigger is common used for penetration of web applications?
...
### 1. Similar to yesterday's question, what is another popular application developed by Telerik that's used for the same purpose?
...
### 1. What's the linux command for secure copy?
...
### 1. On September 11, 2023, which entertainment company posted a statement about being affected by a Cyber attack and had to pause operations for days?
...
### 1. On September 14, Mandiant posted a blog about which threat actor known for sending SMS phishing lures?
...
### 1. On September 21, 2023, Mandiant posted an updated blog on which well known APT group?
...
### 1. In cyber threat intelligence, what is the name for threat actors that sell initial footholds into compromised networks?
...
### 1. Which popular threat actor is known to target Magento-based payment systems?
